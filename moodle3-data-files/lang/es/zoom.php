...
/**
 * Strings for component 'zoom', language 'es', branch 'MOODLE_38_STABLE'
 *
 * @package   zoom
...
$string['attentiveness_score'] = 'Puntuación por atención*';
$string['attentiveness_score_help'] = '* La puntuación por atención disminuye cuando un participante no tiene Zoom en foco por más de 30 segundos cuando alguien está compartiendo una pantalla.';
...
$string['privacy:metadata:zoom_meeting_participants:attentiveness_score'] = 'La puntuación de atención del participante';
...
$string['zoomerr_licensescount_missing'] = 'Se encontró la configuración máxima de zoom, pero no se encontró la configuración de la licencia de la cuenta';
